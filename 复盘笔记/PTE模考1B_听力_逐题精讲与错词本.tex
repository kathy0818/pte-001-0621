...
\ptesub{技巧 · 下次不会错}
\begin{notebox}\small
\textbf{SST 高分捷径：抢短语 $\to$ 拼原句。}听时只抢记关键短语（\emph{education–tool–bridge inequality\;/\;access unequal–socioeconomic·race·gender\;/\;digital divide–remote areas\;/\;initiatives–scholarship·digital platform–foster critical thinking–empower}），10 分钟内用「原句 + However\,/\,Nevertheless\,/\,and」拼起来即可。\\[2pt]
\textbf{拼写要盯：}inequalities · equitable · unevenly · distributed · socioeconomic · scholarship · circumstances。\\[2pt]
\yes\ \textbf{下次不会错：}不可数名词（education/society/research）泛指不加 the；交卷两遍校对——先查冠词、再查动词单复数。
\end{notebox}
\end{qblock}
